...
export function Airdrop() {
    ...
    async function handleAirdrop() {
        await connection.requestAirdrop(wallet.publicKey, 1000000000 * amount); 
    ...
    return <div className="h-[70vh] w-[70vw] mt-12 flex flex-col space-y-4 items-center">
        ...
        <input type="text" onChange={(e)=>setAmount(e.target.value)} className='border bg-[#BBC863] font-bold border-gray-300 p-3 rounded-2xl w-4/5 text-center' placeholder="Enter Amount to Airdrop" />
